...
case class Error(@(ApiModelProperty @field)(description =
                 ...
                 @(ApiModelProperty @field)(description =
                   "An optional id referring to the cover") id: Option[Long] =
                   None,
...
class NotFoundException(message: String = "The cover was not found")
    extends RuntimeException(message)
class CoverAlreadyExistsException(message: String = "This cover already exists",
                                  val id: Long)
    extends RuntimeException(message)
...
class ResultWindowTooLargeException(
    message: String = Error.WindowTooLargeError.description)
    extends RuntimeException(message)
