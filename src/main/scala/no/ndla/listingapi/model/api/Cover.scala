...
case class Cover(
    ...
    @(ApiModelProperty @field)(
      description = "The revision number of this cover") revision: Int,
    ...
    @(ApiModelProperty @field)(description =
      "The labels associated with this cover") labels: CoverLabels,
    @(ApiModelProperty @field)(
      description = "The languages this cover supports") supportedLanguages: Set[
      String],
    @(ApiModelProperty @field)(description =
      "The user id that last updated the cover") updatedBy: String,
    @(ApiModelProperty @field)(description = "When the cover was last updated") updated: Date,
    @(ApiModelProperty @field)(
      description = "The meta theme associated with this cover") theme: String,
    @(ApiModelProperty @field)(description = "The oembed url of the article") oembedUrl: Option[
      String],
)
